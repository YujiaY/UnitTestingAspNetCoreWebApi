...
namespace EmployeeManagement.Test
{
    public class MoqTests
    {
        ...
        public void FetchInternalEmployee_EmployeeFetched_SuggestedBonusMustBeCalculated()
        {
            ...
            employee.SuggestedBonus.Should().Be(400);
        }
        ...
        public void CreateInternalEmployee_InternalEmployeeCreated_SuggestedBonusMustBeCalculated()
        {
            ...
            employeeFactoryMock.Setup(m =>
                    m.CreateEmployee(
                        ...
                        null,
                        false))
                .Returns(new InternalEmployee("Sandy", "Dockx", 5, 3000, false, 1));
            ...
            employeeFactoryMock.Setup(m =>
                    m.CreateEmployee(
                        ...
                        null,
                        false))
                .Returns(new InternalEmployee("SomeoneWithAna", "Dockx", 5, 3000, false, 1));
